        ...
        <div className={styles.contact}>
          <div className={styles.container}>
            <div className={styles.title}>
              Privacy Policy for Rywards Limited
            </div>
            <div className={styles.content}>
              <p>
                At <span>rywards.com</span>, accessible from{" "}
                <span>
                  <Link href="/" passHref>
                    http://rywards.com/
                  </Link>
                ...
                is collected and recorded by rywards.com and how we use it.
              </p>
              <p>
              ...
              <p>
                ...
                information that they shared and/or collect in rywards.com. This
                policy is not applicable to any information collected offline or
                via channels other than this website.
              </p>

              <p className={styles.heading}>Consent</p>
              <p>
              ...
              <p className={styles.heading}>Log Files</p>
              <p>
                rywards.com follows a standard procedure of using log files.
              ...
              <p>
                ...
                the advertising partners of rywards.com.
              </p>
              <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on rywards.com,
              ...
              <p>
                Note that rywards.com has no access to or control over these
                cookies that are used by third-party advertisers.
              </p>

              <p className={styles.heading}>Third Party Privacy Policies</p>
              <p>
                rywards.com&apos;s Privacy Policy does not apply to other
              ...
              <p className={styles.heading}>GDPR Data Protection Rights</p>
              <p>
              ...
              <p className={styles.heading}>Children&apos;s Information</p>
              <p>
              ...
              <p>
                rywards.com does not knowingly collect any Personal Identifiable
              ...
              <p className={styles.heading}>Changes to This Privacy Policy</p>
              <p>
